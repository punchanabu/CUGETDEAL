...
const fetchUserProfile = async (token: unknown) => {
    try {
...
const createUserProfile = async (profileData: unknown) => {
    try{
...
const updateUserProfile = async (profileData: unknown, token: unknown) => {
    try {
        const response = await fetch(`${backendEndPoint}/profile`, {
        method: 'PUT',
        headers: {
