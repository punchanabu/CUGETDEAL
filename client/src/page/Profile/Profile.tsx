...
const Profile = () => {
  return (
    <main className="text-[#F7A6A6] h-screen bg-form font-bold">
      {/* div 1 หัวข้อ */}
      ...
      {/* div 2  */}
      <div className="flex justify-center items-center  bg-zinc-50">
        <button className="shadow-lg w-screen m-2 p-2 border-2 flex justify-center items-center rounded-md text-[#FFFFFF] bg-[#F7A6A6] hover:bg-[#FFFFFF] hover:text-[#F7A6A6]">สรุปงาน</button>
        <button className="shadow-lg w-screen m-2 p-2 border-2 flex justify-center items-center rounded-md text-[#FFFFFF] bg-[#F7A6A6] hover:bg-[#FFFFFF] hover:text-[#F7A6A6]">แก้ไขโปรไฟล์</button>
      </div>
      ...
      <div className="shadow-lg m-4 p-7 border-2 rounded-md bg-[#FFFFFF]">
        <h3 className="text-xl p-1">ประวัติการทำงาน</h3>
      ...
      {/* ข้อมูลการศึกษา */}
      <div className="shadow-lg m-4 p-7 border-2 rounded-md bg-[#FFFFFF]">
        <h3 className="text-xl p-1">ข้อมูลการศึกษา (เพิ่มเติม)</h3>
        <p>- Lorem ipsum dolor sit amet.</p>
        <p>- Lorem ipsum dolor sit amet.</p>
      </div>
      {/* ประกาศนียบัตร */}
      <div className="shadow-lg m-4 p-7 border-2 rounded-md bg-[#FFFFFF]">
        <h3 className="text-xl p-1">ภาษา (เพิ่มเติม)</h3>
        <p>- Lorem ipsum dolor sit amet.</p>
        <p>- Lorem ipsum dolor sit amet.</p>
      </div>
      {/* ภาษา */}
