    ...
    return (
        <main className='bg-white p-10 rounded-xl text-red-400 flex justify-between shadow-md w-3/4'>
            <section className='flex space-x-6'>
                <img className='w-24 h-24 rounded-full' src="https://i.pinimg.com/236x/51/96/3f/51963f47ba77810edde84122d32763f3.jpg" alt="Job Thumbnail" />
            ...
            <section className='flex flex-col items-end justify-end'>
                <Link to={`${data.title}`} className='py-5 px-10 bg-red-400 text-white rounded-xl'>MORE DETAILS</Link>
            </section>
        </main>
    );
};
